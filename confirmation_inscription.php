...
<html>
    ...
    <body data-title='confirmation_inscription.php'>
	  <?php include("menu.php"); ?>
        <div id="bloc_confirmation">
          <ul class="span6 offset4">
            <li>Votre inscription à bien été enregistrée</li>
            <li>Merci de votre intérêt !</li>
            <li>Vous allez être redirigé dans 10 secondes...</li>
          </ul>
	    </div>
